...
window.SIGNAGE_DATA = {
  ...
  prices: {
    updatedAt: "2026年8月4日 9:30発表",
    source: "田中貴金属 RE:TANAKA リサイクル価格参考",
    items: [
      { label: "K24", value: "20,516", unit: "円/g" },
      { label: "K18", value: "14,966", unit: "円/g" },
      { label: "Pt900", value: "6,556", unit: "円/g" },
      { label: "Pt850", value: "6,059", unit: "円/g" }
    ],
