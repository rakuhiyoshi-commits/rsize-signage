...
window.SIGNAGE_DATA = {
  ...
  prices: {
    updatedAt: "2026年7月13日 9:30発表",
    source: "田中貴金属 RE:TANAKA リサイクル価格参考",
    items: [
      { label: "K24", value: "21,273", unit: "円/g" },
      { label: "K18", value: "15,528", unit: "円/g" },
      { label: "Pt900", value: "6,684", unit: "円/g" },
      { label: "Pt850", value: "6,178", unit: "円/g" }
    ],
