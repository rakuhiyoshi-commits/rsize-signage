...
window.SIGNAGE_DATA = {
  ...
  prices: {
    updatedAt: "2026年8月25日 9:30発表",
    source: "田中貴金属 RE:TANAKA リサイクル価格参考",
    items: [
      { label: "K24", value: "24,110", unit: "円/g" },
      { label: "K18", value: "17,633", unit: "円/g" },
      { label: "Pt900", value: "7,808", unit: "円/g" },
      { label: "Pt850", value: "7,228", unit: "円/g" }
    ],
