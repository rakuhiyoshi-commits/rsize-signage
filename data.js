...
window.SIGNAGE_DATA = {
  ...
  prices: {
    updatedAt: "2026年8月10日 9:30発表",
    source: "田中貴金属 RE:TANAKA リサイクル価格参考",
    items: [
      { label: "K24", value: "22,086", unit: "円/g" },
      { label: "K18", value: "16,131", unit: "円/g" },
      { label: "Pt900", value: "7,114", unit: "円/g" },
      { label: "Pt850", value: "6,579", unit: "円/g" }
    ],
