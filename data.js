...
window.SIGNAGE_DATA = {
  ...
  prices: {
    updatedAt: "2026年9月26日 9:30発表",
    source: "田中貴金属 RE:TANAKA リサイクル価格参考",
    items: [
   { label: "K24", value: "21,615", unit: "円/g" },
      { label: "K18", value: "15,781", unit: "円/g" },
      { label: "Pt900", value: "7,178", unit: "円/g" },
      { label: "Pt850", value: "6,639", unit: "円/g" }
    ],
