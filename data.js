...
window.SIGNAGE_DATA = {
  ...
  prices: {
    updatedAt: "2026年8月26日 9:30発表",
    source: "田中貴金属 RE:TANAKA リサイクル価格参考",
    items: [
      { label: "K24", value: "23,931", unit: "円/g" },
      { label: "K18", value: "17,501", unit: "円/g" },
      { label: "Pt900", value: "7,719", unit: "円/g" },
      { label: "Pt850", value: "7,145", unit: "円/g" }
    ],
