...
window.SIGNAGE_DATA = {
  ...
  prices: {
    updatedAt: "2026年7月24日 9:30発表",
    source: "田中貴金属 RE:TANAKA リサイクル価格参考",
    items: [
      { label: "K24", value: "21,354", unit: "円/g" },
      { label: "K18", value: "15,588", unit: "円/g" },
      { label: "Pt900", value: "6,691", unit: "円/g" },
      { label: "Pt850", value: "6,185", unit: "円/g" }
    ],
