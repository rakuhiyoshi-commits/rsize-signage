...
window.SIGNAGE_DATA = {
  ...
  prices: {
    updatedAt: "2026年7月25日 9:30発表",
    source: "田中貴金属 RE:TANAKA リサイクル価格参考",
    items: [
      { label: "K24", value: "21,293", unit: "円/g" },
      { label: "K18", value: "15,543", unit: "円/g" },
      { label: "Pt900", value: "6,630", unit: "円/g" },
      { label: "Pt850", value: "6,127", unit: "円/g" }
    ],
