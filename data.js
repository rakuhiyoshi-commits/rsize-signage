...
window.SIGNAGE_DATA = {
  ...
  prices: {
    updatedAt: "2026年9月7日 9:30発表",
    source: "田中貴金属 RE:TANAKA リサイクル価格参考",
    items: [
  { label: "K24", value: "22,057", unit: "円/g" },
      { label: "K18", value: "16,095", unit: "円/g" },
      { label: "Pt900", value: "7,129", unit: "円/g" },
      { label: "Pt850", value: "6,586", unit: "円/g" }
    ],
