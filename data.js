...
window.SIGNAGE_DATA = {
  ...
  prices: {
    updatedAt: "2026年9月18日 9:30発表",
    source: "田中貴金属 RE:TANAKA リサイクル価格参考",
    items: [
   { label: "K24", value: "21,916", unit: "円/g" },
      { label: "K18", value: "16,005", unit: "円/g" },
      { label: "Pt900", value: "7,190", unit: "円/g" },
      { label: "Pt850", value: "6,651", unit: "円/g" }
    ],
