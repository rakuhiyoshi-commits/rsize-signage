...
window.SIGNAGE_DATA = {
  ...
  prices: {
    updatedAt: "2026年7月1日 14:00発表",
    source: "田中貴金属 RE:TANAKA リサイクル価格参考",
    items: [
      { label: "K24", value: "20,783", unit: "円/g" },
      { label: "K18", value: "15,164", unit: "円/g" },
      { label: "Pt900", value: "6,351", unit: "円/g" },
      { label: "Pt850", value: "5,867", unit: "円/g" }
    ],
