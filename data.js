...
window.SIGNAGE_DATA = {
  ...
  prices: {
    updatedAt: "2026年9月14日 9:30発表",
    source: "田中貴金属 RE:TANAKA リサイクル価格参考",
    items: [
   { label: "K24", value: "21,424", unit: "円/g" },
      { label: "K18", value: "15,640", unit: "円/g" },
      { label: "Pt900", value: "7,077", unit: "円/g" },
      { label: "Pt850", value: "6,545", unit: "円/g" }
    ],
