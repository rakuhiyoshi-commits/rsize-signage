...
window.SIGNAGE_DATA = {
  ...
  prices: {
    updatedAt: "2026年9月24日 9:30発表",
    source: "田中貴金属 RE:TANAKA リサイクル価格参考",
    items: [
   { label: "K24", value: "21,900", unit: "円/g" },
      { label: "K18", value: "15,993", unit: "円/g" },
      { label: "Pt900", value: "7,184", unit: "円/g" },
      { label: "Pt850", value: "6,645", unit: "円/g" }
    ],
