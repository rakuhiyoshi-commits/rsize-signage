...
window.SIGNAGE_DATA = {
  ...
  prices: {
    updatedAt: "2026年9月4日 9:30発表",
    source: "田中貴金属 RE:TANAKA リサイクル価格参考",
    items: [
  { label: "K24", value: "22,421", unit: "円/g" },
      { label: "K18", value: "16,365", unit: "円/g" },
      { label: "Pt900", value: "7,213", unit: "円/g" },
      { label: "Pt850", value: "6,665", unit: "円/g" }
    ],
