...
window.SIGNAGE_DATA = {
  ...
  prices: {
    updatedAt: "2026年9月3日 9:30発表",
    source: "田中貴金属 RE:TANAKA リサイクル価格参考",
    items: [
  { label: "K24", value: "22,418", unit: "円/g" },
      { label: "K18", value: "16,363", unit: "円/g" },
      { label: "Pt900", value: "7,133", unit: "円/g" },
      { label: "Pt850", value: "6,590", unit: "円/g" }
    ],
