...
window.SIGNAGE_DATA = {
  ...
  prices: {
    updatedAt: "2026年7月17日 9:30発表",
    source: "田中貴金属 RE:TANAKA リサイクル価格参考",
    items: [
      { label: "K24", value: "20,840", unit: "円/g" },
      { label: "K18", value: "15,206", unit: "円/g" },
      { label: "Pt900", value: "6,702", unit: "円/g" },
      { label: "Pt850", value: "6,194", unit: "円/g" }
    ],
