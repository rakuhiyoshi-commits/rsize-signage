...
window.SIGNAGE_DATA = {
  ...
  prices: {
    updatedAt: "2026年9月19日 9:30発表",
    source: "田中貴金属 RE:TANAKA リサイクル価格参考",
    items: [
   { label: "K24", value: "22,083", unit: "円/g" },
      { label: "K18", value: "16,129", unit: "円/g" },
      { label: "Pt900", value: "7,307", unit: "円/g" },
      { label: "Pt850", value: "6,760", unit: "円/g" }
    ],
