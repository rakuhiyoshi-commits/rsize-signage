...
window.SIGNAGE_DATA = {
  ...
  prices: {
    updatedAt: "2026年8月3日 9:30発表",
    source: "田中貴金属 RE:TANAKA リサイクル価格参考",
    items: [
      { label: "K24", value: "20,366", unit: "円/g" },
      { label: "K18", value: "14,854", unit: "円/g" },
      { label: "Pt900", value: "6,601", unit: "円/g" },
      { label: "Pt850", value: "6,100", unit: "円/g" }
    ],
