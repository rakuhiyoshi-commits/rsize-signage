...
window.SIGNAGE_DATA = {
  ...
  prices: {
    updatedAt: "2026年7月29日 9:30発表",
    source: "田中貴金属 RE:TANAKA リサイクル価格参考",
    items: [
      { label: "K24", value: "21,215", unit: "円/g" },
      { label: "K18", value: "15,485", unit: "円/g" },
      { label: "Pt900", value: "6,739", unit: "円/g" },
      { label: "Pt850", value: "6,229", unit: "円/g" }
    ],
