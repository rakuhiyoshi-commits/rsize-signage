...
window.SIGNAGE_DATA = {
  ...
  prices: {
    updatedAt: "2026年9月1日 9:30発表",
    source: "田中貴金属 RE:TANAKA リサイクル価格参考",
    items: [
      { label: "K24", value: "22,942", unit: "円/g" },
      { label: "K18", value: "16,752", unit: "円/g" },
      { label: "Pt900", value: "7,370", unit: "円/g" },
      { label: "Pt850", value: "6,811", unit: "円/g" }
    ],
