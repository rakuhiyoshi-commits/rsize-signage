...
window.SIGNAGE_DATA = {
  ...
  prices: {
    updatedAt: "2026年7月21日 9:30発表",
    source: "田中貴金属 RE:TANAKA リサイクル価格参考",
    items: [
      { label: "K24", value: "20,963", unit: "円/g" },
      { label: "K18", value: "15,298", unit: "円/g" },
      { label: "Pt900", value: "6,591", unit: "円/g" },
      { label: "Pt850", value: "6,090", unit: "円/g" }
    ],
