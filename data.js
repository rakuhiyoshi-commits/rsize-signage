...
window.SIGNAGE_DATA = {
  ...
  prices: {
    updatedAt: "2026年8月22日 9:30発表",
    source: "田中貴金属 RE:TANAKA リサイクル価格参考",
    items: [
      { label: "K24", value: "23,595", unit: "円/g" },
      { label: "K18", value: "17,251", unit: "円/g" },
      { label: "Pt900", value: "7,758", unit: "円/g" },
      { label: "Pt850", value: "7,182", unit: "円/g" }
    ],
