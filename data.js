...
window.SIGNAGE_DATA = {
  ...
  prices: {
    updatedAt: "2026年9月16日 9:30発表",
    source: "田中貴金属 RE:TANAKA リサイクル価格参考",
    items: [
   { label: "K24", value: "21,380", unit: "円/g" },
      { label: "K18", value: "15,607", unit: "円/g" },
      { label: "Pt900", value: "7,112", unit: "円/g" },
      { label: "Pt850", value: "6,578", unit: "円/g" }
    ],
